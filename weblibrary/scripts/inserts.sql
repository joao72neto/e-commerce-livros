...
(3, 2, 2, 30, '2023-12-10', 39.92),
(1, 3, 6, 25, '2023-08-15', 29.56),
(5, 3, 6, 15, '2024-01-05', 30.74),
(7, 4, 2, 60, '2023-07-22', 26.85),
(2, 4, 2, 40, '2023-11-18', 28.38),
(6, 5, 2, 30, '2023-10-10', 34.54),
(3, 5, 2, 25, '2023-12-15', 35.77),
(7, 6, 2, 50, '2023-09-05', 23.00),
(1, 6, 2, 20, '2024-01-20', 24.23),
(5, 7, 6, 40, '2023-08-30', 31.78),
(1, 7, 6, 35, '2023-11-25', 32.96),
(4, 8, 1, 30, '2023-10-25', 46.60),
(6, 8, 1, 25, '2023-12-05', 44.60),
(4, 9, 5, 35, '2023-11-15', 46.60),
...
-- LOG TABLE INSERTS (TESTS)

-- 1. Cliente fez um novo pedido
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(1, NOW(), 'João Silva', 'INSERT', 'Cliente João Silva realizou um novo pedido #1001.');

-- 2. Admin alterou o status do pedido
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(1, NOW(), 'Admin João Silva', 'STATUS_CHANGE', 'Pedido #1001 alterado de "Em processamento" para "Em trânsito".');

-- 3. Cliente atualizou endereço
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(2, NOW(), 'Maria Oliveira', 'UPDATE', 'Cliente Maria Oliveira atualizou o endereço de entrega.');

-- 4. Admin deletou um cupom
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(1, NOW(), 'Admin João Silva', 'DELETE', 'Admin João Silva removeu o cupom de desconto #CUPOM2025.');

-- 5. Cliente realizou login
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(3, NOW(), 'Carlos Mendes', 'LOGIN', 'Cliente Carlos Mendes realizou login no sistema.');

-- 6. Cliente alterou senha
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(3, NOW(), 'Carlos Mendes', 'PASSWORD_CHANGE', 'Cliente Carlos Mendes alterou sua senha.');

-- 7. Admin editou um produto
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(1, NOW(), 'Admin João Silva', 'UPDATE', 'Admin João Silva alterou o preço do produto "Livro de Programação Avançada".');

-- 8. Cliente atualizou perfil
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(4, NOW(), 'Fernanda Souza', 'PROFILE_UPDATE', 'Cliente Fernanda Souza atualizou os dados do perfil.');

-- 9. Admin cancelou um pedido
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(2, NOW(), 'Admin João Silva', 'STATUS_CHANGE', 'Pedido #1002 alterado de "Em trânsito" para "Cancelado".');

-- 10. Cliente realizou novo pedido
INSERT INTO `log` 
(log_clt_id, log_dataHora, log_usuario, log_operacao, log_desc)
VALUES 
(4, NOW(), 'Fernanda Souza', 'INSERT', 'Cliente Fernanda Souza realizou um novo pedido #1003.');
